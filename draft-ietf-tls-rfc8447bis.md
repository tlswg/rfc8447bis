...
- Update the "Recommended" column with the changes as listed below.  This
  ...
  "Reserved" (46) as "D". A reference to this document SHALL be added to these entries.
...
- Update the following note on the recommended column
